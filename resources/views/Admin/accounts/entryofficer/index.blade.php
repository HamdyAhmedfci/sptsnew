                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              <p class="card-description" style="margin: 20px;">
                                <a href="{{ url('admin/register') }}" > <button type="button" class="btn btn-dark">Create Entry_Officer Account</button></a>
                              </p>
                                <div class="row">
                                              ...
                                              @foreach ($data as $x)
                                                 ...
                                                 <td>{{ $x->id }} </td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{  url('entry/show/staff/'.$x->id) }}"> <button type="button" class="btn btn-primary"  style="margin-right: 10px;"> Show</button></a>
