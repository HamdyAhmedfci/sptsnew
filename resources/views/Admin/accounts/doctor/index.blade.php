            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="primary">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{ url('affair/index/staff') }}" >Entry Officer</a></li>
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              <p class="card-description" style="margin: 20px;">
                                <a href="{{ url('admin/register') }}" > <button type="button" class="btn btn-info">Create Doctor Account</button></a>
                              </p>
                                <div class="row">
                                            ...
                                            <tbody>
                                              ...
                                              <td>{{ $x->id }} </td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{  url('doctor/show/staff/'.$x->id) }}"> <button type="button" class="btn btn-primary"  style="margin-right: 10px;"> Show</button></a>
