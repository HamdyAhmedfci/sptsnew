        ...
        <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ url('admin/index/staff') }}" > Admin </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('manager/index/staff') }}" > Manager </a>
                </li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('affair/index/staff') }}" >Student Affair</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('entry/officer/index/staff') }}" >Entry Officer</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('doctor/index/staff') }}" >Doctor</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('specialist/index/staff') }}" >Specialist</a></li>
              </ul>
              </div>
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              <p class="card-description" style="margin: 20px;">
                                <a href="{{ url('admin/register') }}" > <button type="button" class="btn btn-dark">Create Admin Account</button></a>
                              </p>
                                <div class="row">
                                              ...
                                              @foreach ($data as $x)
                                                 ...
                                                 <td>{{ $x->id }} </td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{ url('admin/show/staff/'.$x->id) }}"> <button type="button" class="btn btn-info"  style="margin-right: 10px;"> Show</button></a>
                      
                                                      <a data-toggle="modal" data-target="#modal_single_del{{ $x->id }}"  class="btn btn-danger">Delete</a>
                                                ...
                                                <div class="modal" id="modal_single_del{{ $x->id }}" tabindex="-1" role="dialog">
