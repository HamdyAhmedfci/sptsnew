                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              <p class="card-description" style="margin: 20px;">
                                <a href="{{ url('admin/register') }}" > <button type="button" class="btn btn-warning">Create Specialist Account</button></a>
                              </p>
                                <div class="row">
                                            ...
                                            <tbody>
                                              ...
                                              <td>{{ $x->id }} </td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{ url('specialist/show/staff/'.$x->id) }}"> <button type="button" class="btn btn-info"  style="margin-right: 10px;"> Show </button></a>
