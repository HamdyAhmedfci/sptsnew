                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              <p class="card-description" style="margin: 20px;">
                                <a href="{{ url('admin/register') }}" > <button type="button" class="btn btn-warning">Create Manager Account</button></a>
                              </p>
                                <div class="row">
                                            ...
                                            <tbody>
                                              ...
                                              <th  scope="row">{{ ++$i }} </th>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{  url('manager/show/staff/'.$x->id) }}"> <button type="button" class="btn btn-primary"  style="margin-right: 10px;"> Show</button></a>
